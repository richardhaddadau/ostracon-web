...
import { Moon, Sun } from "./icons/Ostracon-Std";
...
const SideNav = (props) => {
  ...
  return (
    <nav className="flex flex-col justify-between overflow-x-auto w-16 min-h-full bg-white dark:bg-primary-500 shadow-lg">
      <Navigation
        links={props.links}
